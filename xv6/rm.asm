...
main(int argc, char *argv[])
{
  ...
  4d:	50                   	push   %eax
  4e:	e8 cc 02 00 00       	call   31f <unlink>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e1:	8a 91 24 08 00 00    	mov    0x824(%ecx),%dl
...
printf(int fd, char *fmt, ...)
{
 ...
 517:	75 23                	jne    53c <printf+0xfc>
          s = "(null)";
 519:	c7 45 f4 1c 08 00 00 	movl   $0x81c,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5db:	a1 40 08 00 00       	mov    0x840,%eax
 ...
 6a6:	a3 40 08 00 00       	mov    %eax,0x840
}
 6ab:	90                   	nop
 6ac:	c9                   	leave  
 6ad:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 704:	83 c4 10             	add    $0x10,%esp
  return freep;
 707:	a1 40 08 00 00       	mov    0x840,%eax
}
 70c:	c9                   	leave  
 70d:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 71e:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 721:	a1 40 08 00 00       	mov    0x840,%eax
 726:	89 45 f0             	mov    %eax,-0x10(%ebp)
 729:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 72d:	75 23                	jne    752 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 72f:	c7 45 f0 38 08 00 00 	movl   $0x838,-0x10(%ebp)
 736:	8b 45 f0             	mov    -0x10(%ebp),%eax
 739:	a3 40 08 00 00       	mov    %eax,0x840
 73e:	a1 40 08 00 00       	mov    0x840,%eax
 743:	a3 38 08 00 00       	mov    %eax,0x838
    base.s.size = 0;
 748:	c7 05 3c 08 00 00 00 	movl   $0x0,0x83c
 74f:	00 00 00 
  }
 ...
 7a5:	a3 40 08 00 00       	mov    %eax,0x840
      return (void*)(p + 1);
 ...
 7b0:	eb 3b                	jmp    7ed <malloc+0xdf>
    ...
    if(p == freep)
 7b2:	a1 40 08 00 00       	mov    0x840,%eax
